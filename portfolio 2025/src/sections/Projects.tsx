    ...
    <section className="pb-16 lg:py-24">
      <div className="container">
        ...
        <p className="text-center text-white/60 mt-4 md:text-lg lg-text-xl max-w-md mx-auto">
          ...
          temporibus voluptates dicta earum quis quae non iste dolore suscipit
          nisi eum, facilis cupiditate? Libero at enim assumenda numquam vitae
          fuga!
        </p>
            ...
            >
              ...
              <div className="lg:grid lg:grid-cols-2 lg:gap-16">
                <div className="lg:pb-16">
                  <div className="bg-gradient-to-r from-emerald-300 to-sky-400 inline-flex gap-2 tracking-widest font-bold uppercase text-sm text-transparent bg-clip-text">
